      ...
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl leading-none font-serif">
              From Open-Source <span className="text-blue-600">Tools</span> to
              AI-Powered Platforms
            </h1>
            <p className="mt-6 text-lg text-gray-600 leading-relaxed font-mono">
              PWM is a launchpad for products, ideas, and community-led
              innovation.
            </p>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="lg:w-5/12">
                <div
                  className={`h-full w-full bg-gradient-to-br ${product.bgColor} rounded-2xl shadow-xl flex items-center justify-center p-10`}
                >
