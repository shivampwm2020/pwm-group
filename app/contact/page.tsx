      ...
      >
        ...
        <SectionContainer className="py-20 lg:py-28">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <SectionTitle className="text-4xl font-extrabold sm:text-5xl md:text-6xl leading-tight">
              Let's Start a <span className="text-blue-600">Conversation</span>
            </SectionTitle>
            <SectionDescription className="mt-6 leading-relaxed">
              Have questions about our products, services, or community? Our team is ready to assist you.
            </SectionDescription>
          </div>
        </SectionContainer>
        ...
        <SectionContainer>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <Card className="flex flex-col items-center text-center">
              ...
              <CardDescription className="mb-4">Our team typically responds within 24 hours</CardDescription>
              <a href="mailto:connect@programmingwithmaurya.com" className="text-blue-600 font-medium hover:text-blue-700 transition-colors">
            ...
            <Card className="flex flex-col items-center text-center">
              ...
              <CardDescription className="mb-4">Available Monday-Friday, 9am-6pm IST</CardDescription>
              <a href="tel:+916391277940" className="text-blue-600 font-medium hover:text-blue-700 transition-colors">
                +91 63912 77940
              </a>
            </Card>
            ...
            <Card className="flex flex-col items-center text-center">
              ...
              <CardDescription className="mb-4">Chat with our customer support team</CardDescription>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-blue-100">connect@programmingwithmaurya.com</p>
                    </div>
                  </div>
      ...
      <Section variant="secondary" padding="md">
        <SectionContainer>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card variant="ghost">
              <CardTitle className="mb-4">What industries do you serve?</CardTitle>
              <CardDescription>
            ...
            <Card variant="ghost">
              <CardTitle className="mb-4">How quickly can you develop a custom solution?</CardTitle>
              <CardDescription>
            ...
            <Card variant="ghost">
              <CardTitle className="mb-4">Do you offer support after deployment?</CardTitle>
              <CardDescription>
            ...
            <Card variant="ghost">
              <CardTitle className="mb-4">How do I join your developer community?</CardTitle>
              <CardDescription>
