...
const communityInitiatives = [
  ...
  },
  {
    ...
    description: 'PWM Group began as a small peer-to-peer learning group where developers shared knowledge, asked questions, and helped each other grow. Over time, as our community matured and our projects evolved, we realized the need to turn this energy into action — to build things together that solve real-world problems.',
...
export default function CommunityPage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl leading-tight">
              From Learning <span className="text-green-600">to Building</span> Together
            </h1>
      ...
      <div id="initiatives" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-gray-900">PWM Group's Community</h2>
            ...
            >
              <div className="p-8 md:p-0">
                <div className="flex flex-col md:flex-row">
                  <div className={`md:w-2/5 bg-gradient-to-br ${initiative.bgColor} p-12 md:p-16 flex items-center justify-center`}>
                    <div className="text-white text-center">
                      <h3 className="text-3xl font-bold mb-4">{initiative.name}</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
              <div className="px-6 py-4 border-b border-gray-100 bg-green-50">
                <h3 className="text-xl font-bold text-gray-900 mt-1">Weekly Newsletter</h3>
              </div>
              <div className="px-6 py-4">
                <p className="text-gray-600 mb-6">Launching a focused newsletter covering tech trends, AI innovations, product stories, and community updates.</p>
              </div>
            </div>
            
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
              <div className="px-6 py-4 border-b border-gray-100 bg-green-50">
                <h3 className="text-xl font-bold text-gray-900 mt-1">Community Building</h3>
              </div>
              <div className="px-6 py-4">
                <p className="text-gray-600 mb-6">Creating dedicated communities for AI engineers, indie hackers, product builders, and users of each PWM tool.</p>
              </div>
            </div>
            
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
              <div className="px-6 py-4 border-b border-gray-100 bg-green-50">
                <h3 className="text-xl font-bold text-gray-900 mt-1">Sessions & Events</h3>
              </div>
              <div className="px-6 py-4">
                <p className="text-gray-600 mb-6">Organizing live sessions with industry experts, startup founders, and AI practitioners to guide the community.</p>
              </div>
            </div>
            
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
              <div className="px-6 py-4 border-b border-gray-100 bg-green-50">
                <h3 className="text-xl font-bold text-gray-900 mt-1">New Platforms</h3>
              </div>
              <div className="px-6 py-4">
                <p className="text-gray-600 mb-6">Continued development of innovative tools for developers and non-tech users.</p>
              </div>
            </div>
          </div>
        </div>
