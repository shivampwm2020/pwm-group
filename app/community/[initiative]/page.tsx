...
type StatKey = keyof Pick<
  (typeof initiatives)["production-gurus"],
  "members" | "resources" | "countries"
>;
...
export default function CommunityInitiativePage({
  ...
  return (
    <div className="bg-white">
          ...
          <SlideIn>
            <div className="lg:text-center mb-20">
              ...
              <p className="mt-2 max-w-3xl mx-auto text-lg text-gray-600">
                Join us at these exclusive events to learn, network, and grow
      ...
      <section
        id="join"
        className=" rounded-b-4xl bg-gradient-to-r from-blue-600 to-indigo-700 py-20 sm:py-24"
      >
